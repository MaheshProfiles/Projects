...
public class API_Register_ReSend_OTP {
    private static final String MODULE = "API_Register_ReSend_OTP";
    ...
    public API_Register_ReSend_OTP(JSONObject obj, Listener_OTP_Register_ResendOTP mCallBack, Activity mActivity) {
        this.obj = obj;
                       ...
                       /* {
                        ...
                        if (response.has("success")) {
                            ...
                            if (success.equals("true")) {
                                mCallBack.onGetResendOTP(response.getString("message"));
                            } else {
