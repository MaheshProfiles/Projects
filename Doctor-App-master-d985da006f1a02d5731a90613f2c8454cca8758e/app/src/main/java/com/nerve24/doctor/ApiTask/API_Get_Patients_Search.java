...
public class API_Get_Patients_Search {
    private static final String MODULE = "API_Get_Patients_Search";
    private static String TAG = "", Str_Msg = "";
    private JsonArrayRequest req;

    private String Str_Url = Constants_API.ApiSearchPatient;
    private Activity mActivity;

    private Listener_Patient_Search mCallBack;
    private String str;

    public API_Get_Patients_Search(String str, Listener_Patient_Search mCallBack, Activity mActivity) {
        this.str = str;
    ...
    public void getPatients() {
        ...
        try {
             req = new JsonArrayRequest(Request.Method.POST,
                    Str_Url, str, new Response.Listener<JSONArray>() {
                @Override
                public void onResponse(JSONArray response) {
                    try {
                        ...
                        if (response.length() > 0) {
                            ...
                            mCallBack.onGetPatients(nameList,idNameMap,patientSearchMap);
                        }
                    } catch (Exception e) {
                        mCallBack.onGetPatientsError(e.toString());
                        e.printStackTrace();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    mCallBack.onGetPatientsError(Str_Msg);
                }
            }) {
               /* @Override
