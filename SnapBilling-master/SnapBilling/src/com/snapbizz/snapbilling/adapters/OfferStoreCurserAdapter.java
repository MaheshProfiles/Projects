...
public class OfferStoreCurserAdapter extends CursorAdapter {
	...
	public OfferStoreCurserAdapter(Context context, Cursor c,
			boolean autoRequery,
		...
		if (cursor != null) {
			...
			if (!cursor.isClosed()) {
				...
				inventoryProductsWrapper.productTaxTextView.setText(cursor
						.getFloat(4) + context.getString(R.string.percentage));
				inventoryProductsWrapper.productPurchasePriceTextView
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		View convertView = inflater.inflate(R.layout.listitem_offer_store,
				null);
