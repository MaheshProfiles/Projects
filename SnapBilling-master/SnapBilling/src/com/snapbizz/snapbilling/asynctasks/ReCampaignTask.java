...
public class ReCampaignTask extends AsyncTask<String, Void, List<Campaigns>>{
	...
	public ReCampaignTask(Context context,
	...
	protected List<Campaigns> doInBackground(String... params) {
		...
		List<Campaigns> campaignsList= new ArrayList<Campaigns>();
         ...
         Date yesterDay = dateFormat.parse(dateFormat.format(cal1.getTime())); 
             ...
             String sqlCampaignsQuery=" select id,campaign_id,campaign_name,start_date,end_date,campaign_type,image_uid,campaign_code,company from campaigns where end_date >'"+currentTimestamp+"' and start_date <'"+tomorrwTimestamp+"'";
