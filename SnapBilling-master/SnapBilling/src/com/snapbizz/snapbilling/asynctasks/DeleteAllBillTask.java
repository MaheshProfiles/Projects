...
public class DeleteAllBillTask extends AsyncTask<String, Void, Boolean> {
	...
	public DeleteAllBillTask(Context context,
	...
	protected Boolean doInBackground(String... params) {
		try {
			    ...
			    while (st.hasMoreElements()) {
			    	Transaction transaction = SnapBillingUtils.getHelper(context).getTransactionDao().queryForEq("transaction_id",  st.nextElement()).get(0);
