...
public class BrandSelectionAdapter extends ArrayAdapter<Brand> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            brandAdapterWrapper.brandImageView = (ImageView) convertView.findViewById(R.id.brand_imageview);
            brandAdapterWrapper.brandNameTextView = (TextView) convertView.findViewById(R.id.brandname_textview);
        ...
        brandAdapterWrapper.brandImageView.setImageDrawable(SnapCommonUtils.getBrandDrawable(brand, context));
