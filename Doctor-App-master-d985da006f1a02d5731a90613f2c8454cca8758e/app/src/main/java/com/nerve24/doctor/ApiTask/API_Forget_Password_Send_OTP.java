...
public class API_Forget_Password_Send_OTP {
    private static final String MODULE = "API_FPSO";
    ...
    public API_Forget_Password_Send_OTP(JSONObject obj, Listener_Forget_password mCallBack, Activity mActivity) {
        this.obj = obj;
        ...
        try {
            ...
            JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST,
                ...
                public void onResponse(JSONObject obj) {
                    try {
                        ...
                        if (response.getString("success").equals("true")) {
                            mCallBack.onOTPsent(response.getString("message"));
                        } else {
                            mCallBack.onOTPsentError(response.getString("message"));
                        }

                    } catch (Exception e) {
                        mCallBack.onOTPsentError(e.toString());
                        e.printStackTrace();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    mCallBack.onOTPsentError(Str_Msg);
                }
            }) {
                @Override
