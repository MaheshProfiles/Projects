...
public class API_Forget_Password {
    private static final String MODULE = "API_Forget_Password";
    private static String TAG = "", Str_Msg = "";

    private String Str_Url = Constants_API.ApiForgetPassword;
    private Activity mActivity;

    private Listener_Forget_password mCallBack;
    private String obj;

    public API_Forget_Password(String obj, Listener_Forget_password mCallBack, Activity mActivity) {
        this.obj = obj;
        ...
        try {
            ...
            JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST,
                    ...
                    try {
                       ...
                       //{"success":false,"statusCode":0,"message":"New Password should not be same as previous password"}
                        ...
                        if (response.getString("success").equals("true")) {
                            mCallBack.onPasswordChange(response.getString("message"));
                        } else {
                            mCallBack.onPasswordChangeError(response.getString("message"));
                        }

                    } catch (Exception e) {
                        mCallBack.onPasswordChangeError(e.toString());
                        e.printStackTrace();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    mCallBack.onPasswordChangeError(Str_Msg);
                }
            }) {
                @Override
