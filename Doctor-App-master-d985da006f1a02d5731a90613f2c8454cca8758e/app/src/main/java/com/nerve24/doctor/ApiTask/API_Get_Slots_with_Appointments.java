...
public class API_Get_Slots_with_Appointments {
    ...
    public API_Get_Slots_with_Appointments(String obj, Listener_Get_Slots_with_Appointments mCallBack, Activity mActivity) {
        this.obj = obj;
