...
public class API_Save_Premium_Slots {
    private static final String MODULE = "API_Save_Premium_Slots";
    private static String TAG = "", Str_Msg = "";

    private String Str_Url = Constants_API.ApiSavePremiumSlots;
    private Activity mActivity;

    private Listener_Save_Premium_Slots mCallBack;
    JSONArray obj;

    public API_Save_Premium_Slots(JSONArray obj, Listener_Save_Premium_Slots mCallBack, Activity mActivity) {
        this.obj = obj;
                    ...
                    try {
                       // {"success":true,"statusCode":1,"message":"slotSetup is saved successfully"}
                        ...
                        if (response.has("success")) {
                            ...
                            if (str.equals("true")) {
                                mCallBack.onSlotsSaved(response.getString("message"));
                            } else {
                                mCallBack.onSlotsSavedError(response.getString("message"));
                            }
                        } else {
