...
public class API_Register_Send_OTP {
    private static final String MODULE = "API_Register_Send_OTP";
    ...
    public API_Register_Send_OTP(JSONObject obj, Listener_OTP_Register_ResendOTP mCallBack, Activity mActivity) {
        this.obj = obj;
                    ...
                    try {
                        ...
                        if (response.has("success")) {
                            ...
                            if (success.equals("true")) {
                                mCallBack.onGetOTP(response.getString("message"));
                            } else {
