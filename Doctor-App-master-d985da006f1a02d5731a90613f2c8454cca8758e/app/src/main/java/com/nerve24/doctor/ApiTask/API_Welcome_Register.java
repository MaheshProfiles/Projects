...
public class API_Welcome_Register {
    private static final String MODULE = "API_Welcome_Register";
    private static String TAG = "", Str_Msg = "";

    private String Str_Url = Constants_API.ApiCreateUser;
    private Activity mActivity;

    private Listener_Welcome_Register mCallBack;
    private String obj;

    public API_Welcome_Register(String obj, Listener_Welcome_Register mCallBack, Activity mActivity) {
        this.obj = obj;
            ...
            JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST,
                ...
                public void onResponse(JSONObject response) {
                    try {
                      ...
                      //  {"success":true,"statusCode":1,"message":"User Successfully Created"}
                        if (response.getString("success").equals("true")) {
                            mCallBack.onRegisterSuccess(response.getString("message"));
                        } else {
                            mCallBack.onRegistrationError(response.getString("message"));
                        }

                    } catch (Exception e) {
                        mCallBack.onRegistrationError(e.toString());
                        e.printStackTrace();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    mCallBack.onRegistrationError(Str_Msg);
                }
            }) {
                @Override
