...
public class AlertsWidgetProvider extends AppWidgetProvider {
	private static final String TAG = AlertsWidgetProvider.class
			.getSimpleName();
	...
	public void onUpdate(Context context, AppWidgetManager appWidgetManager,
		...
		RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.alerts_widget_layout);
		
		String path = SnapInventoryUtils.getAlertWidgetImagePath(context);
	...
	public static PendingIntent buildButtonPendingIntent(Context context) {
		...
		intent.setAction(SnapInventoryConstants.WIDGET_UPDATE_ACTION_ALERTS);
