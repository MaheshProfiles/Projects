...
public class API_Save_Payment {
    private static final String MODULE = "API_Save_Payment";
    private static String TAG = "", Str_Msg = "";

    private String Str_Url = Constants_API.ApiAccountDetails;
    private Activity mActivity;

    private Listener_Save_Payment mCallBack;
    JSONObject obj;

    public API_Save_Payment(JSONObject obj, Listener_Save_Payment mCallBack, Activity mActivity) {
        this.obj = obj;
        ...
        try {
            ...
            JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST,
                    ...
                    try {
                       // {"success":true,"statusCode":1,"message":"priceing saved successfully"}
                        ...
                        if (response.has("success")) {
                            ...
                            if (str.equals("true")) {
                                mCallBack.onPaymentSaved(response.getString("message"));
                            } else {
                                mCallBack.onPaymentSavedError(response.getString("message"));
                            }
                        } else {
                            mCallBack.onPaymentSavedError("Try again later!");
                        }

                    } catch (Exception e) {
                        mCallBack.onPaymentSavedError(e.toString());
                        e.printStackTrace();
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    mCallBack.onPaymentSavedError(Str_Msg);
                }
            }) {
               /* @Override
